...
rem Build folders
set BUILD=%cd%\build\resources\ShaderCache\
...
copy %RESOURCES_OUTPUT%simple.vert.spv %BUILD%simple.vert.spv
...
copy %RESOURCES_OUTPUT%simple.frag.spv %BUILD%simple.frag.spv
